...
**MermZen** 是一个专注纯粹的 Mermaid 图表编辑器。打开即写，即时渲染，无多余干扰——体验就这么简单。
...
- [Vite 7](https://vitejs.dev/) — 构建工具、开发服务器、模块打包
- [TypeScript](https://www.typescriptlang.org/) — 类型安全（渐进式迁移，JS 模块共存）
- [Mermaid 11](https://mermaid.js.org/) — 图表渲染
- [CodeMirror 6](https://codemirror.net/) — 代码编辑器
- [SVGO](https://github.com/svg/svgo) — SVG 导出优化压缩
- [pako](https://github.com/nodeca/pako) — 分享链接的 deflate 压缩

所有生产依赖均本地打包，运行时无需 CDN。
